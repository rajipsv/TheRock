...
def _score_severity(
    ...
    if any(k in names_lower for k in ("miopen", "hipdnn", "ml-lib")):
        rationale.append("ML library change detected")
    ...
    rationale.append("No manifest changes in range")
